import { formatDistance, subDays, subMonths, subYears } from 'date-fns';
...
const data: ICompactPosition[] = [
  {
    id: '1',
    open: subDays(new Date(), 30).getTime(),
    close: subDays(new Date(), 29).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 10000,
    amount_quote_out: 0,
    pnl: 276.77,
    roi: 2.76,
  },
  {
    id: '2',
    open: subDays(new Date(), 28).getTime(),
    close: subDays(new Date(), 27).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 30000,
    amount_quote_out: 0,
    pnl: 1021.36,
    roi: 3.4,
  },
  {
    id: '3',
    open: subDays(new Date(), 27).getTime(),
    close: subDays(new Date(), 26).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 18500,
    amount_quote_out: 0,
    pnl: 445.87,
    roi: 2.4,
  },
  {
    id: '4',
    open: subDays(new Date(), 25).getTime(),
    close: subDays(new Date(), 24).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 36500,
    amount_quote_out: 0,
    pnl: 1874.44,
    roi: 5.14,
  },
  {
    id: '5',
    open: subDays(new Date(), 24).getTime(),
    close: subDays(new Date(), 23).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 14266,
    amount_quote_out: 0,
    pnl: 184.55,
    roi: 1.3,
  },
  {
    id: '6',
    open: subDays(new Date(), 23).getTime(),
    close: subDays(new Date(), 22).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
  ...
  {
    id: '7',
    open: subDays(new Date(), 22).getTime(),
    close: subDays(new Date(), 21).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 36855,
    amount_quote_out: 0,
    pnl: 2576.84,
    roi: 7,
  },
  {
    id: '8',
    open: subDays(new Date(), 21).getTime(),
    close: subDays(new Date(), 20).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 15466.32,
    amount_quote_out: 0,
    pnl: 614.33,
    roi: 3.97,
  },
  {
    id: '9',
    open: subDays(new Date(), 20).getTime(),
    close: subDays(new Date(), 19).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 28466.31,
    amount_quote_out: 0,
    pnl: 1555.32,
    roi: 5.46,
  },
  {
    id: '10',
    open: subDays(new Date(), 19).getTime(),
    close: subDays(new Date(), 18).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 44551.36,
    amount_quote_out: 0,
    pnl: 3485.13,
    roi: 7.82,
  },
  {
    id: '11',
    open: subDays(new Date(), 18).getTime(),
    close: subDays(new Date(), 17).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 28463,
    amount_quote_out: 0,
    pnl: 845.33,
    roi: 2.96,
  },
  {
    id: '12',
    open: subDays(new Date(), 17).getTime(),
    close: subDays(new Date(), 16).getTime(),
    archived: false,
    entry_price: 0,
    gain: 0,
    amount: 0,
    amount_quote: 0,
    amount_quote_in: 36455,
    amount_quote_out: 0,
    pnl: 2855.12,
    roi: 7.83,
  },
...
const Positions = () => {
  ...
  const { loading, error } = useAPIFetch<ICompactPosition[]>(
    useMemo(
      () => ({
        fetchFunc: {
  ...
  const pnls = useMemo(
    () => (Array.isArray(records) ? records.map((record) => formatPNL(record.pnl)) : []),
    [records],
  );
      ...
      <section className="w-full lg:w-10/12 xl:w-9/12 2xl:w-8/12">
        ...
        <header className="flex justify-start items-center">
          ...
          {processed.pnlChart.length > 0 && (
            <Badge className="ml-1 -mt-4">{formatBadgeCount(processed.pnlChart.length, 99)}</Badge>
          )}
                    ...
                    <Fragment key={record.id}>
                      ...
                      >
                        <div className="max-w-[60%] sm:max-w-[70%]">
                          <p className="font-medium truncate">{openTimes[i]}</p>
                          <p className="text-light text-sm truncate">{timeDistances[i]}</p>
                        </div>
