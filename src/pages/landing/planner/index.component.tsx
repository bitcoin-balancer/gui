...
const Planner = memo(
  ({
    ...
    <div className="w-full flex justify-center items-start">
      <section className="w-full md:w-11/12 xl:w-9/12 2xl:w-7/12">
        <div className="w-full flex flex-col md:flex-row justify-center items-center gap-4">
          <aside className="w-full text-center md:text-left p-3">
          ...
          <article className="w-full 2xl:w-10/12 px-5 sm:px-0">
            <Carousel
              opts={{
                align: 'center',
                loop: true,
