...
const Footer = memo(
  ({
    ...
    <div className="w-full flex justify-center items-start bg-primary text-slate-50 shadow-6">
      <footer className="w-full xl:w-11/12 2xl:w-8/12 py-20 md:py-28 px-3 flex flex-col lg:flex-row justify-start items-start gap-10">
        {/* *******
         * BRAND *
         ******* */}
        <div className="flex-1 grow">
          ...
          <p className="mt-3 text-lg font-bold">Trade like a professional consistently</p>
