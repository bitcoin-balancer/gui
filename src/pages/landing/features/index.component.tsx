  ...
  <div className="w-full flex justify-center items-start">
    <section className="w-full lg:w-11/12 xl:w-10/12 2xl:w-9/12">
      ...
      <div className="w-full flex flex-col md:flex-row justify-center items-center gap-8">
        <aside className="w-full flex-1 text-center md:text-left p-3 z-10">
          <h2 className="text-4xl sm:text-5xl font-bold">
            <strong className="text-increase-1">Increase</strong> your holdings during price crashes
          </h2>
          <p className="mt-5 text-lg">
            Balancer uses a series of{' '}
            <Button
              variant="link"
              className="text-lg text-sky-700 p-0"
              onClick={() => navigateToSection('indicators')}
            >
              indicators
            </Button>{' '}
            to assess the probability of price reversals following significant price drops, allowing
            you to capitalize on potential rebound opportunities.
          </p>
        </aside>

        <article className="w-full flex-1 -mt-20 sm:mt-0">
          <CandlestickChart
       ...
       * DECREASE *
       ********** */}
      <div className="w-full flex flex-col-reverse md:flex-row justify-center items-center md:gap-10 mt-8 sm:mt-14 md:mt-0">
        <article className="w-full flex-1 -mt-16 sm:mt-0">
          <CandlestickChart
            height={breakpoint === 'xs' || breakpoint === 'sm' ? 400 : 500}
            data={DECREASE_DATA}
        ...
        <aside className="w-full flex-1 text-center md:text-left p-3 z-10">
          ...
          <p className="mt-5 text-lg">
            ...
            automatically reduces your position size at intervals, taking into account the magnitude
            of your gains. The larger the profit, the more significant the reduction and the more
