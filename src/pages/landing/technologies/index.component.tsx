  ...
  <div className="w-full flex justify-center items-start">
    <section className="w-full sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-5/12 2xl:w-4/12 p-3">
      <header className="text-center">
        <h2 className="text-center text-4xl sm:text-5xl font-bold">Tech stack</h2>
        <p className="text-xs sm:text-sm mt-2 text-light">Technologies used to build Balancer</p>
      </header>
