...
const APICard = memo(({ data }: { data: IServerState }) => {
   ...
   ********************************************************************************************** */
  return (
    <Card className="flex-1 w-full py-2">
      <div className="flex justify-start items-start p-0 md:p-6">
        <div>
          ...
          <div>
            {availableUpdates === null ? (
              ...
              >
                ...
                <p className="truncate text-sm">{lastCommit}</p>
              </a>
            ) : (
              <Link
      ...
      <CardContent className="w-full">
        ...
        <div className="flex justify-start items-center mt-6">
          ...
          >
            <p className="max-w-48 md:max-w-32 lg:max-w-52 truncate">{buildAPIURL('')}</p>
            <ExternalLink
              aria-hidden="true"
        ...
        <div className="flex justify-start items-center mt-5 text-ellipsis overflow-hidden">
          <p className="text-light text-sm">Last scan</p>
          <span className="flex-1"></span>
          <p className="max-w-48 md:max-w-32 lg:max-w-48 truncate">
