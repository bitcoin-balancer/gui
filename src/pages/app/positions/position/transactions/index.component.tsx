...
const Transactions = memo(({ position, setSidenavOpen }: IPositionComponentProps) => {
  ...
  return (
    <div className="page-container flex justify-center items-start animate-in fade-in duration-700">
      <section className="w-full md:w-8/12 lg:w-7/12 xl:w-6/12 2xl:w-5/12">
        {/* ********
         * HEADER *
         ******** */}
        <header className="flex justify-start items-center mb-5">
          ...
          <h1 className="text-2xl font-semibold leading-none tracking-tight">Transactions</h1>
                ...
                <Fragment key={record.id}>
                  ...
                  >
                    <div className="max-w-[70%] sm:max-w-[85%]">
                      ...
                      <p className="text-light text-sm truncate">{dates[i]}</p>
                    </div>
