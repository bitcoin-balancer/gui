 ...
 */
const Service = memo(
  ({ service, version, availableUpdates, updateService }: IServiceComponentProps) => {
    /* **********************************************************************************************
     *                                       REACTIVE VALUES                                        *
     ********************************************************************************************** */

    // info regarding the running version
    const lastCommit = useMemo(() => VersionService.buildLastCommitText(version), [version]);
      ...
      <article className="flex justify-start items-center">
        <div className="max-w-[75%] sm:max-w-[70%]">
          ...
          <a
            ...
            style={{ marginTop: 3 }}
          >
            <CodeXml className="mr-1 w-4 h-4 min-w-5" />
            <p className="truncate">{lastCommit}</p>
          </a>
        </div>
