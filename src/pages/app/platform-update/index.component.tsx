  ...
  return (
    <>
      <div className="page-container flex justify-center items-start animate-in fade-in duration-700">
        <section className="w-full sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12 2xl:w-3/12">
          <h1 className="text-2xl font-semibold leading-none tracking-tight">Platform update</h1>
      ...
      >
        <DialogContent>
          ...
          >
            ...
            >
              <p className="mt-3 mb-2">1. Connect to your virtual machine (Droplet).</p>
              ...
              <p className="mt-5 mb-2">
                3. Start the <Code>CLI-LITE</Code>:
              </p>
              <CodeSnippet
                code="npm start"
                isCommand={true}
              ...
              <p className="mt-5 mb-2">
                4. Select the <strong>"Docker"</strong> menu and execute the following action:
              </p>
