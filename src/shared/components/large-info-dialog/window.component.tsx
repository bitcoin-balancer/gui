...
const Window = () => (
  <>
    ...
    <p>
      ...
      Each split represents a different time frame, providing insights into long-term and short-term
      trends (giving more importance to the short-term).
    </p>
    <p>
    ...
    <ul>
      <li>
        ...
        <span className="text-light text-sm">last ~32 hours (128 items)</span>
      </li>
      <li>
        <Badge
          variant="secondary"
        ...
        <span className="text-light text-sm">last ~24 hours (96 items)</span>
      </li>
      <li>
        <Badge
          variant="secondary"
        ...
        <span className="text-light text-sm">last ~16 hours (64 items)</span>
      </li>
      <li>
        <Badge
          variant="secondary"
        ...
        <span className="text-light text-sm">last ~8 hours (32 items)</span>
      </li>
      <li>
        <Badge
          variant="secondary"
        ...
        <span className="text-light text-sm">last ~5 hours (20 items)</span>
      </li>
      <li>
        <Badge
          variant="secondary"
        ...
        <span className="text-light text-sm">last ~3.25 hours (13 items)</span>
      </li>
      <li>
        <Badge
          variant="secondary"
        ...
        <span className="text-light text-sm">last ~1.75 hours (7 items)</span>
      </li>
      <li>
        <Badge
          variant="secondary"
        ...
        <span className="text-light text-sm">last ~45 minutes (3 items)</span>
      </li>
    </ul>
    <p>
    ...
    <ul>
      <li>
        <Badge className="text-sm bg-increase-2">2</Badge>{' '}
        <strong className="text-increase-2">Increasing strongly</strong>{' '}
        <span className="text-light text-sm"> - a clear upward trend with strong momentum</span>
      </li>
      <li>
        <Badge className="text-sm bg-increase-1">1</Badge>{' '}
        <strong className="text-increase-1">Increasing</strong>{' '}
        <span className="text-light text-sm">
          {' '}
          - a positive trend, but with less intensity than "Increasing strongly"
        </span>
      </li>
      <li>
        <Badge className="text-sm bg-stateless">0</Badge>{' '}
        <strong className="text-stateless">Sideways</strong>{' '}
        <span className="text-light text-sm">
          {' '}
          - a period of consolidation with no clear direction
        </span>
      </li>
      <li>
        <Badge className="text-sm bg-decrease-1">-1</Badge>{' '}
        <strong className="text-decrease-1">Decreasing</strong>{' '}
        <span className="text-light text-sm">
          {' '}
          - a negative trend with moderate downward momentum
        </span>
      </li>
      <li>
        <Badge className="text-sm bg-decrease-2">-2</Badge>{' '}
        <strong className="text-decrease-2">Decreasing strongly</strong>{' '}
        <span className="text-light text-sm">
          {' '}
          - a strong downward trend with significant downward momentum
        </span>
      </li>
    </ul>
    ...
    <p>
      When the window identifies the price of Bitcoin has crashed, it activates the{' '}
      <strong>Reversal Indicator</strong>. This module analyzes various indicators to determine
      potential opportunities for opening or increasing the position, seeking to capitalize on the
    ...
    <div className="flex justify-start items-center mt-7 gap-2">
