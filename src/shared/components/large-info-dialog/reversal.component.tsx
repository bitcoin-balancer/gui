...
const Reversal = () => (
  <>
    ...
    <p>
      ...
      reversals. A minimum number of points must be accumulated across all indicators to trigger a
      reversal event.
    </p>
    <p>
      The score is calculated every time the Window Indicator fetches new data (every ~3 seconds by
      default).
    </p>
    ...
    <p>
      The Reversal Indicator's activation during price crashes aligns with Balancer's "value
      averaging" trading strategy, which aims to increase portfolio size during price dips and
      reduce it during rallies. This strategic approach leverages the potential for price reversals
      following significant market downturns.
    </p>
    ...
    <img
      ...
      height="578"
    />
    <p className="text-light text-xs text-center">Example of a price crash</p>
  </>
);
