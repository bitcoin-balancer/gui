...
const Strategy = () => (
  <>
    <p>
      The Strategy monitors the state of the market and is responsible for opening, increasing, and
      decreasing positions based on events.
    </p>
    ...
    <img
      ...
      height="578"
    />
    <p className="text-light text-xs text-center">Example of a price rally</p>
  </>
);
